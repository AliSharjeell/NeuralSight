...
def main():
    ...
    parser.add_argument("--smooth", type=float, default=0.14, help="0..1, higher is snappier")
    parser.add_argument("--sensitivity", type=float, default=0.78, help="overall gaze sensitivity multiplier; lower values reduce twitchiness")
    parser.add_argument("--stability-window", type=int, default=11, help="number of recent predictions used for median stabilization")
    parser.add_argument("--steady-radius-px", type=float, default=28.0, help="keep the gaze point steadier while predictions stay within this radius")
    parser.add_argument("--response-px", type=float, default=230.0, help="distance over which the filter ramps from steady to responsive")
    parser.add_argument("--head-assist", type=float, default=None, help="0..1 blend weight for head/face assist in hybrid mode")
    parser.add_argument("--x-gain", type=float, default=1.18, help="horizontal range multiplier; keeps edges reachable after lowering sensitivity")
    parser.add_argument("--y-gain", type=float, default=1.10, help="vertical range multiplier; keeps edges reachable after lowering sensitivity")
    parser.add_argument(
        "--control-mouse",
    ...
    parser.add_argument("--cursor-deadzone-px", type=float, default=14.0, help="ignore tiny cursor moves under this pixel distance")
    parser.add_argument("--edge-zone-ratio", type=float, default=0.18, help="outer screen band ratio where edge assist starts pushing outward")
    parser.add_argument("--edge-boost-px", type=float, default=170.0, help="maximum outward push near the screen edges")
    ...
    parser.add_argument("--mouth-open-threshold", type=float, default=0.16, help="mouth-open ratio required to arm a click")
    parser.add_argument("--mouth-release-threshold", type=float, default=0.09, help="mouth-open ratio required before another mouth click can arm")
    ...
    parser.add_argument("--click-cooldown", type=float, default=0.65, help="minimum seconds between mouth-triggered clicks")
