...
def main():
    ...
    parser.add_argument("--smooth", type=float, default=0.20, help="0..1, higher is snappier")
    parser.add_argument("--sensitivity", type=float, default=0.96, help="overall gaze sensitivity multiplier; lower values reduce twitchiness")
    parser.add_argument("--stability-window", type=int, default=7, help="number of recent predictions used for median stabilization")
    parser.add_argument("--steady-radius-px", type=float, default=18.0, help="keep the gaze point steadier while predictions stay within this radius")
    parser.add_argument("--response-px", type=float, default=150.0, help="distance over which the filter ramps from steady to responsive")
    parser.add_argument("--head-assist", type=float, default=None, help="0..1 blend weight for head/face assist in hybrid mode")
    parser.add_argument("--x-gain", type=float, default=1.06, help="horizontal sensitivity multiplier")
    ...
    parser.add_argument("--cursor-deadzone-px", type=float, default=8.0, help="ignore tiny cursor moves under this pixel distance")
    parser.add_argument("--edge-zone-ratio", type=float, default=0.10, help="outer screen band ratio where edge assist starts pushing outward")
    parser.add_argument("--edge-boost-px", type=float, default=95.0, help="maximum outward push near the screen edges")
