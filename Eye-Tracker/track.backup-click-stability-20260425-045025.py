...
def main():
    ...
    parser.add_argument("--smooth", type=float, default=0.13, help="0..1, higher is snappier")
    ...
    parser.add_argument("--steady-radius-px", type=float, default=30.0, help="keep the gaze point steadier while predictions stay within this radius")
    parser.add_argument("--response-px", type=float, default=260.0, help="distance over which the filter ramps from steady to responsive")
    parser.add_argument("--head-assist", type=float, default=None, help="0..1 blend weight for head/face assist in hybrid mode")
    parser.add_argument("--x-gain", type=float, default=1.35, help="horizontal range multiplier for reaching left and right screen edges")
    parser.add_argument("--y-gain", type=float, default=1.30, help="vertical range multiplier for reaching top and bottom screen edges")
    parser.add_argument(
        "--control-mouse",
